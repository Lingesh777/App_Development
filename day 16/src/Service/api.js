...
const deleteproduct=(pid)=> axios.delete(`${URI}/auth/delete/${pid}`,{headers})
...
export{userregister,userlogin,getproduct,getproductbyname,getproductbycat,addproduct,editproduct,deleteproduct,getreview,addreview,deleterev}