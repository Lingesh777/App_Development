...
export const SideBarUser = () => {
  ...
  return (
    <div className='sidebar d-flex-c'>
        <div className='gdicon' style={{position:'absolute',top:'100px'}}><GridViewIcon /></div>
        <Button  style={{color:'black',padding:'20px',fontSize:'15px',fontWeight:'bold'}} onClick={()=>{navigate('/user')}} >DashBoard</Button>
        <div style={{position:'absolute',top:'170px'}}><ProductionQuantityLimitsIcon/></div>
        ...
        <div style={{position:'absolute',top:'235px'}}><AddShoppingCartIcon/></div>
        <Button  style={{color:'black',padding:'20px',fontSize:'15px',fontWeight:'bold'}} onClick={()=>{navigate('/user/cart')}}>Cart</Button>
        <div style={{position:'absolute',top:'300px'}}><EditCalendarIcon/></div>
       ...
       {/* <div style={{position:'absolute',top:'300px'}}><AssessmentOutlinedIcon/></div>
        ...
        {/* <Button  style={{color:'black',padding:'20px',fontSize:'15px',fontWeight:'bold'}} onClick={()=>{navigate('/user/edit')}}>Edit profile</Button> */}
