  ...
  return (
    <div className="topbar d-flex-r">
      <div className='topicon'><LocalGroceryStoreIcon style={{fontSize:'40px'}} /></div>
        ...
        <div className='toprev' onClick={()=>navigate('/user/review')}><Button style={{color:'black'}}><RateReviewIcon style={{fontSize:'40px'}}/></Button></div>
       <div className="notyicon">
        ...
        <Notification isOpen1={open1} onClose={closeNotification}/>
        </div>
