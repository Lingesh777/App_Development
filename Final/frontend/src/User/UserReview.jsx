  ...
  />
        ...
        <div className="content d-flex-c">
            <div className="revbody">
                ...
                <div className="revcol">
                    <Button style={{backgroundColor:'red',color:'white',width:'10vw',marginLeft:'100px'}} onClick={()=>{navigate('/user')}}>Later</Button>
                    <Button style={{backgroundColor:'green',color:'white',marginLeft:'10px',width:'10vw'}} onClick={handleSubmit}>Post</Button>
                </div> 
            </div>
        </div>
      </div>
