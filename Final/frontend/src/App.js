...
import { Dummyupd } from "./Admin/Dummyupd";
import { UserEdit } from "./User/UserEdit";
import { NotifyAdmin } from "./Bar/NotifyAdmin";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/updateproduct' element={<Dummyupd/>}></Route>
          <Route path='/report' element={<Reports/>}></Route>
          <Route path='/contact' element={<Contacts/>}></Route>
          <Route path='/viewnot' element={<NotifyAdmin/>}></Route>
          </Route>
